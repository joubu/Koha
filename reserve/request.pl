...
use C4::Reserves qw( AlterPriority CancelReserve ToggleLowestPriority ToggleSuspend CanBookBeReserved GetMaxPatronHoldsForRecord CanItemBeReserved OPACItemHoldsAllowed IsAvailableForItemLevelRequest );
use C4::Biblio qw( GetBiblioItemInfosOf GetFrameworkCode );
use C4::Items qw( get_hostitemnumbers_of );
use C4::Koha qw( getitemtypeimagelocation );
use C4::Circulation qw( CheckIfIssuedToPatron GetTransfers _GetCircControlBranch GetBranchItemRule );
