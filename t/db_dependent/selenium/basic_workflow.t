...
for my $biblionumber ( @biblionumbers ) {
    ...
    $driver->find_element('//fieldset[@id="circ_circulation_issue"]/input[@type="submit"]')->click;
    $nb_of_checkouts++;
...
for my $biblionumber ( @biblionumbers ) {
    ...
    $driver->find_element('//input[@id="barcode"]')->send_keys('t_value_bib'.$biblionumber);
    $driver->find_element('//form[@action="/cgi-bin/koha/circ/returns.pl"]/div/fieldset/input[@type="submit"]')->click;
