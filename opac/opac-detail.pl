...
use C4::Biblio qw( GetMarcBiblio GetFrameworkCode CountItemsIssued GetBiblioData GetMarcISBN GetMarcAuthors GetMarcSubjects GetMarcSeries GetMarcUrls GetMarcHosts GetMarcNotes GetRecordValue GetCOinSBiblio GetMarcControlnumber GetMarcISSN );
...
use C4::Reserves qw( OnShelfHoldsAllowed GetReserveStatus );
