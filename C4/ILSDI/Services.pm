...
use C4::Members qw( patronflags GetPendingIssues );
use C4::Items qw( GetItem GetItemnumbersForBiblio GetItemsByBiblioitemnumber );
use C4::Circulation qw( GetBiblioIssues CanBookBeRenewed barcodedecode decode CanBookBeIssued AddRenewal );
use C4::Accounts qw( getcharges );
use C4::Biblio qw( GetBiblioItemByBiblioNumber GetMarcBiblio );
use C4::Reserves qw( CanBookBeReserved IsAvailableForItemLevelRequest CalculatePriority AddReserve CanItemBeReserved CancelReserve );
use C4::Context;
